...
public class StudentJpaService implements StudentRepository {
    ...
    public Student addStudent(Student student) {
        ...
        try {
            ...
            if (student.getEmail() != null &&
                    studentJpaRepository.existsByEmailIgnoreCase(student.getEmail())) {
    ...
    public Student updateStudent(int studentId, Student student) {
        ...
        try {
            ...
            // UPDATE EMAIL
            if (student.getEmail() != null) {
                studentJpaRepository.findByEmailIgnoreCase(student.getEmail())
                        .filter(found -> found.getStudentId() != studentId)
                        .ifPresent(found -> {
                            throw new ResponseStatusException(
                                    HttpStatus.BAD_REQUEST,
                                    "Email already exists"
    ...
    public boolean isEmailExists(String email) {
        ...
        try {
            ...
            return studentJpaRepository.existsByEmailIgnoreCase(email);
